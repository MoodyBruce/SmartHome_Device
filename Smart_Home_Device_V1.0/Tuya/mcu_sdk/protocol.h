...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "p4oivvsq1l2b2axj"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//当前亮度(只上报)
//备注:当前环境相对亮度，0~100%数值越高，环境越亮
#define DPID_LIGHT_VALUE 101
//亮度下限设置(可下发可上报)
//备注:环境亮度下限设置
#define DPID_MINLIGHT_SET 102
//亮度报警(只上报)
//备注:当前亮度过低
#define DPID_LIGHT_ALARM 103
//灯控开关(可下发可上报)
//备注:灯控开关
#define DPID_LIGHT_SWITCH 104
